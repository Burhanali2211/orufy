...
const products = [
  ...
  },
  {
    ...
    description: 'The legendary Shamama — a complex blend of over 40 botanicals including herbs, flowers and spices. A signature of AligarhAttarHouse\'s attar craft.',
...
// ---------------------------------------------------------------------------
const siteSettings = [
  { setting_key: 'site_name', setting_value: 'AligarhAttarHouse', setting_type: 'text', category: 'general', description: 'Website name', is_public: true },
  ...
  { setting_key: 'contact_email', setting_value: 'info@AligarhAttarHouse.com', setting_type: 'email', category: 'contact', description: 'Contact email', is_public: true },
