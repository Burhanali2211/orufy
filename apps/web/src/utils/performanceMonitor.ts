...
class PerformanceMonitor {
  ...
  private initializeObservers() {
    ...
    try {
      ...
      try {
        // Check if PerformanceObserver and layout-shift are supported
      ...
      const navigationObserver = new PerformanceObserver((list) => {
        ...
        entries.forEach((entry: PerformanceEntry) => {
          ...
          this.recordMetric('ttfb', navEntry.responseStart - navEntry.requestStart, 'timing');
          this.recordMetric('dom_content_loaded', navEntry.domContentLoadedEventEnd - navEntry.fetchStart, 'timing');
          this.recordMetric('load_complete', navEntry.loadEventEnd - navEntry.fetchStart, 'timing');
          this.detailedMetrics.ttfb = navEntry.responseStart - navEntry.requestStart;
        });
      });
