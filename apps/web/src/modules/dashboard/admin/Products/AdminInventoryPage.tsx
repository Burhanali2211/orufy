...
export const AdminInventoryPage: React.FC = () => {
  ...
  const fetchInventory = async () => {
    try {
      const response = await apiClient.get<{ success: boolean; data: any[] }>(`/admin/inventory?search=${search}&status=${statusFilter}`);
      if (response.success) {
  ...
  const fetchMovements = async () => {
    try {
      const response = await apiClient.get<{ success: boolean; data: any[] }>('/admin/inventory/movements');
      if (response.success) {
  ...
  const handleAdjustStock = async () => {
    ...
    try {
      const response = await apiClient.post<{ success: boolean; data: any }>('/admin/inventory/adjust', {
