...
import { updateUserProfile } from '../../lib/legacyDb';
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-end pt-6 border-t border-gray-200">
          ...
          >
            {loading ? (
              <>
                <svg className="hidden -ml-1 mr-2 h-4 w-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
