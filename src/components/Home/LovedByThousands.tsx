...
const features = [
  {
    ...
    description: "Get your premium products delivered within 24-48 hours across major cities.",
    icon: Zap,
  },
  {
  ...
  },
  {
    ...
    description: "Made using centuries-old methods from the attar capital of India — AligarhAttarHouse.",
    icon: Clock,
  }
];
    ...
    <section className="py-12 sm:py-16 md:py-32 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center mb-20">
          ...
          >
            <span className="w-2 h-2 rounded-full bg-purple-600 hidden" />
            <span className="text-gray-600 font-bold text-xs tracking-widest uppercase">The AligarhAttarHouse Advantage</span>
          </motion.div>
