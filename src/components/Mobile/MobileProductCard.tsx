            ...
            <div className="flex-1 p-2.5 min-h-[64px] sm:min-h-[80px] flex flex-col justify-between">
              ...
              <div className="flex items-center justify-between mt-1.5">
                <div className="flex items-center space-x-1">
                  <span className="font-semibold text-neutral-900 text-xs">₹{(product.price / 100).toLocaleString('en-IN', { minimumFractionDigits: 2 })}</span>
      ...
      <div className="relative">
        ...
        <div className="absolute top-1.5 left-1.5 flex flex-col space-y-1">
          ...
          <span className={`${stockStatus.color} text-white text-[10px] px-1.5 py-0.5 rounded-full font-bold shadow-sm flex items-center space-x-1`}>
            <div className={`w-1 h-1 rounded-full bg-white ${product.stock > 0 ? 'hidden' : ''}`}></div>
      ...
      <div className="p-2.5 sm:p-3 space-y-2">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-1.5">
            <span className="font-semibold text-neutral-900 text-base">₹{(product.price / 100).toLocaleString('en-IN', { minimumFractionDigits: 2 })}</span>
            {product.originalPrice && (
