...
import { 
  ...
  Eye, Users, ArrowUpRight, ArrowDownRight, Calendar, RefreshCw
} from 'lucide-react';
    ...
    try {
      ...
      if (ordersResponse.success && productsResponse.success) {
        ...
        setMetrics([
          { 
            label: 'Total Revenue', 
            value: `₹${(totalRevenue / 100).toLocaleString('en-IN', { minimumFractionDigits: 2 })}`, 
            change: 'Calculated', 
            trend: 'up', 
            icon: DollarSign, 
            color: 'cyan' 
          ...
          { 
            ...
            value: `₹${(avgOrderValue / 100).toLocaleString('en-IN', { maximumFractionDigits: 0 })}`, 
            change: 'Calculated', 
            trend: 'up', 
            icon: BarChart3, 
            color: 'emerald' 
                  ...
                  topProducts.map((product, index) => (
                    <tr key={product.name || index} className="hover:bg-white/5">
                      ...
                      <td className="p-4 text-right text-cyan-400 font-semibold">
                        ₹{(product.revenue / 100).toLocaleString('en-IN', { minimumFractionDigits: 2 })}
                      </td>
