...
import { 
  ...
  ArrowUpRight, ArrowDownRight, Wallet, Clock, CheckCircle, RefreshCw
} from 'lucide-react';
...
export const SellerEarningsPage: React.FC = () => {
  ...
  const formatCurrency = (amount: number) => `₹${Math.abs(amount / 100).toLocaleString('en-IN', { minimumFractionDigits: 2 })}`;
