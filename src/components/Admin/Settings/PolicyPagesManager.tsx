...
const REQUIRED_POLICY_PAGES: Omit<PolicyPage, 'exists' | 'inFooter' | 'footerLinkId' | 'footerLinkText' | 'section'>[] = [
  ...
  },
  {
    ...
    razorpayUrl: 'https://AligarhAttarHouse.com/shipping-policy',
  },
  {
    id: 'terms',
    name: 'Terms and Conditions',
    route: '/terms-of-service',
    razorpayUrl: 'https://AligarhAttarHouse.com/terms-of-service',
  },
  {
    id: 'refund',
    name: 'Cancellations and Refunds',
    route: '/refund-policy',
    razorpayUrl: 'https://AligarhAttarHouse.com/refund-policy',
  },
  {
    id: 'privacy',
    name: 'Privacy Policy',
    route: '/privacy-policy',
    razorpayUrl: 'https://AligarhAttarHouse.com/privacy-policy',
  },
];
