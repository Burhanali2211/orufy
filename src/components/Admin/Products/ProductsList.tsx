    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-extrabold text-stone-900">Products</h1>
            <p className="text-xs text-stone-500 font-medium">Manage your product catalog</p>
          </div>
        </div>
        <button
          onClick={() => navigate('/admin/products/add')}
          className="flex items-center gap-2 px-4 py-2.5 bg-slate-900 hover:bg-slate-800 text-white rounded-xl font-extrabold transition-colors min-h-[44px] shadow-sm flex-shrink-0 text-xs"
        >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <div className="bg-white border border-stone-200/80 rounded-2xl p-4 shadow-2xs">
          ...
          <p className="text-xs text-stone-500 font-semibold">All Products</p>
          <p className="text-2xl font-extrabold text-stone-900">{totalItems}</p>
        </div>
      ...
      <div className="md:hidden space-y-2">
        {loading ? (
          <div className="bg-white border border-gray-200 rounded-xl p-8 text-center">
            <div className="w-6 h-6 border-2 border-amber-500 border-t-transparent rounded-full hidden mx-auto mb-2" />
