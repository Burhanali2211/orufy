...
export const useLongPress = (
  ...
  }, [onLongPress, threshold, onStart, safeSetTimeout, triggerHapticFeedback]);

  const clear = useCallback((e: React.TouchEvent | React.MouseEvent, shouldTriggerFinish = true) => {
    if (timerId.current) {
