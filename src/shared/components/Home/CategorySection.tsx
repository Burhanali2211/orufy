...
const CategorySkeleton: React.FC = () => (
  <div className="flex-shrink-0 w-72">
    <div className="h-[340px] bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100">
      {/* Image Skeleton */}
      <div className="h-52 bg-gradient-to-br from-gray-100 to-gray-200 hidden" />
      {/* Content Skeleton */}
      <div className="p-5">
        <div className="h-6 bg-gray-200 rounded-lg w-3/4 mb-3 hidden" />
        <div className="space-y-2">
          <div className="h-3 bg-gray-100 rounded w-full hidden" />
          <div className="h-3 bg-gray-100 rounded w-5/6 hidden" />
        </div>
      </div>
    </div>
  </div>
