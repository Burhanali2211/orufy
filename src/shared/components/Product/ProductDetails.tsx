                ...
                <div className="p-8 lg:p-12 flex flex-col max-h-[85vh] overflow-y-auto">
                  <div className="mb-8">
                    ...
                    <div className="flex items-baseline gap-4 mb-8">
                      <span className="text-4xl font-bold text-gray-900">₹{(product.price / 100).toLocaleString('en-IN', { minimumFractionDigits: 2 })}</span>
                      {product.originalPrice && (
                        <span className="text-xl text-gray-400 line-through">₹{(product.originalPrice / 100).toLocaleString('en-IN', { minimumFractionDigits: 2 })}</span>
                      )}
                      {product.originalPrice && (
                  ...
                  <div className="mt-auto">
                    <div className="flex items-center gap-6 mb-8">
                      ...
                      <div className="text-sm">
                        <p className="font-bold text-gray-900">Total: ₹{((product.price * quantity) / 100).toLocaleString('en-IN', { minimumFractionDigits: 2 })}</p>
