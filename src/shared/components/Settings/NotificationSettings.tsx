...
export const NotificationSettings: React.FC = () => {
  ...
  const handleToggle = (category: keyof typeof settings, setting: keyof typeof settings['email']) => {
  ...
  type NotificationKey = 'orderUpdates' | 'promotions' | 'newsletter' | 'security' | 'productUpdates';

  const notificationTypes: { key: NotificationKey, title: string, description: string }[] = [
    {
      key: 'orderUpdates',
      title: 'Order Updates',
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          ...
          <div className="flex flex-wrap gap-4">
            <button
              onClick={() => {
                setSettings(prev => ({
                  email: { orderUpdates: true, promotions: true, newsletter: true, security: true, productUpdates: true },
                  push: { orderUpdates: true, promotions: true, newsletter: true, security: true, productUpdates: true },
                  sms: { orderUpdates: true, promotions: true, newsletter: true, security: true, productUpdates: true }
                }));
              }}
            ...
            <button
              onClick={() => {
                setSettings(prev => ({
                  email: { orderUpdates: false, promotions: false, newsletter: false, security: false, productUpdates: false },
                  push: { orderUpdates: false, promotions: false, newsletter: false, security: false, productUpdates: false },
                  sms: { orderUpdates: false, promotions: false, newsletter: false, security: false, productUpdates: false }
                }));
              }}
