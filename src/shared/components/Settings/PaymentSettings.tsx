...
export const PaymentSettings: React.FC = () => {
  ...
  const handleAddPaymentMethod = () => {
    showNotification({ message: 'Add payment method functionality coming soon', type: 'info', title: 'Info' });
  };

  const handleEditPaymentMethod = (method: PaymentMethod) => {
    showNotification({ message: `Edit payment method ${method.provider} functionality coming soon`, type: 'info', title: 'Info' });
  };
