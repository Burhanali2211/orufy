...
const updateUserSecuritySettings = async (settings: Partial<UserSecuritySettings>): Promise<boolean> => true;
...
export const SecuritySettings: React.FC = () => {
  ...
  const handleSecuritySettingChange = async (setting: keyof UserSecuritySettings, value: any) => {
