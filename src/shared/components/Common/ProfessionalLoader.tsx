    ...
    <div className="flex flex-col items-center justify-center space-y-6">
      ...
      {showBrand && (
        <div className="relative w-20 h-20 flex items-center justify-center">
          {/* Outer rotating ring */}
          <div className="absolute inset-0 rounded-full border-4 border-transparent border-t-gray-900 border-r-gray-900 hidden"
               style={{ animationDuration: '2s' }} />

          {/* Middle rotating ring (opposite direction) */}
          <div className="absolute inset-2 rounded-full border-2 border-transparent border-b-gray-500 border-l-gray-500 hidden"
      ...
      <div className="w-48 h-1 bg-gray-200 rounded-full overflow-hidden">
        <div className="h-full bg-gray-900 rounded-full hidden"
             style={{ width: '60%' }} />
      </div>
