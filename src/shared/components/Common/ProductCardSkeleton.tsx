...
export const ProductCardSkeleton: React.FC<ProductCardSkeletonProps> = ({ variant = 'featured' }) => {
  ...
  if (variant === 'featured') {
    return (
      <div className="bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100 hidden">
        {/* Image Skeleton */}
  ...
  if (variant === 'bestseller') {
    return (
      <div className="relative bg-white rounded-2xl overflow-hidden shadow-md border-2 border-gray-200 hidden">
        {/* Rank Badge */}
  ...
  return (
    <div className="relative bg-white rounded-xl overflow-hidden shadow-sm border border-gray-200 hidden">
      {/* Badges */}
