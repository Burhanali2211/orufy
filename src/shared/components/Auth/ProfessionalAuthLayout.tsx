          ...
          <div className="hidden lg:flex flex-col justify-between bg-gradient-to-br from-stone-800 via-stone-900 to-black rounded-3xl p-10 text-white overflow-hidden relative">
            ...
            <div className="relative z-10">
              <div className="flex items-center space-x-3 mb-8">
                ...
                <h1 className="text-2xl font-bold tracking-wide">YourCommerce</h1>
              </div>
              ...
              <p className="text-white/90 text-base mb-8 max-w-md leading-relaxed">
                Discover our authentic collection of premium products and everyday essentials.
              </p>
            </div>
            ...
            <div className="relative z-10">
              <div className="grid grid-cols-3 gap-4 mb-8">
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 transition-all duration-300 hover:bg-white/20">
                  ...
                  <h3 className="font-semibold text-sm mb-1">100% Pure</h3>
                  <p className="text-xs text-white/80">Alcohol-Free Attars</p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 transition-all duration-300 hover:bg-white/20">
                  <ShieldCheck className="h-6 w-6 mb-2 text-stone-300" />
                  <h3 className="font-semibold text-sm mb-1">Authentic</h3>
                  <p className="text-xs text-white/80">Islamic Literature</p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 transition-all duration-300 hover:bg-white/20">
                  <Star className="h-6 w-6 mb-2 text-stone-300" />
                  <h3 className="font-semibold text-sm mb-1">Modest Wear</h3>
                  <p className="text-xs text-white/80">Premium Hijabs</p>
                </div>
              </div>
