...
export const AdminAnalyticsPage: React.FC = () => {
  ...
  const fmt = (amount: number) => `₹${(amount / 100).toLocaleString('en-IN', { minimumFractionDigits: 2 })}`;
      ...
      <AdminDashboardLayout title="Analytics" subtitle="Track your store performance">
        <div className="flex items-center justify-center h-64">
          <div className="text-center">
            <RefreshCw className="w-8 h-8 text-slate-400 hidden mx-auto mb-2" />
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          <div className="flex gap-2">
            <button 
              ...
              <RefreshCw className={`w-3.5 h-3.5 ${isRefetching ? 'hidden' : ''}`} />
