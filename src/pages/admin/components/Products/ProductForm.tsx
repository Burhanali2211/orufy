  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const productData = {
        ...
        minStockLevel: parseInt(formData.min_stock_level) || 0,
        ...
        sellerName: product?.sellerName || 'AligarhAttarHouse',
      ...
      if (product) {
        await updateMutation.mutateAsync({ ...productData, id: product.id } as Product);
