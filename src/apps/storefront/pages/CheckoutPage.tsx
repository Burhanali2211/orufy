...
const inputClass =
  'w-full px-4 py-3 rounded-xl border border-stone-200 text-gray-900 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-stone-900 transition-all bg-white';
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
        <div className="text-center max-w-md">
          ...
          <button onClick={() => navigate('/products')} className="px-6 py-2.5 bg-stone-900 text-white rounded-xl text-xs font-bold">Continue Shopping</button>
        </div>
      </div>
    );
  }
