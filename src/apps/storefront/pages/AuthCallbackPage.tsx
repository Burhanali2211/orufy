...
const AuthCallbackPage: React.FC = () => {
  ...
  useEffect(() => {
    const handleCallback = async () => {
      try {
        // Our backend handles the OAuth/email verification callback.
        // It reads the ?code or ?token from the URL and sets a session cookie.
        ...
        const result = await apiClient.post('/auth/callback', { code });
