...
import { useCustomerPayments, PaymentMethod } from '@/shared/hooks/customer/useCustomerPayments';
    ...
    try {
      ...
      if (paymentType === 'card') {
        ...
        dbData = {
          ...
          expiry_month: parseInt(month).toString(),
          expiry_year: parseInt('20' + year).toString(),
