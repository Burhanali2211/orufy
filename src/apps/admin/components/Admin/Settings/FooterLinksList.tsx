...
export const FooterLinksList: React.FC = () => {
  ...
  const toggleActive = async (link: FooterLink) => {
    try {
      await apiClient.put(`/admin/settings/footer/${link.id}`, { is_active: !link.is_active });
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-64">
        <div className="hidden rounded-full h-12 w-12 border-b-2 border-purple-600"></div>
      </div>
    );
  }
                  ...
                  >
                    <div className="flex items-start justify-between gap-2 mb-2">
                      ...
                      <button
                        ...
                        className={`p-1.5 sm:p-1 rounded transition-colors flex-shrink-0 min-h-11 min-w-[44px] sm:min-h-auto sm:min-w-auto flex items-center justify-center ${link.is_active
                    ...
                    <div className="flex items-center gap-1 sm:gap-2">
                      <button
                        ...
                        className="flex-1 flex items-center justify-center gap-1 px-2 py-1.5 sm:py-1 bg-purple-100 text-purple-700 rounded text-xs hover:bg-purple-200 active:bg-purple-300 transition-colors min-h-11 sm:min-h-auto"
                      >
                      ...
                      <button
                        ...
                        className="px-2 py-1.5 sm:py-1 bg-red-100 text-red-700 rounded text-xs hover:bg-red-200 active:bg-red-300 transition-colors min-h-11 min-w-[44px] sm:min-h-auto sm:min-w-auto flex items-center justify-center"
                      >
