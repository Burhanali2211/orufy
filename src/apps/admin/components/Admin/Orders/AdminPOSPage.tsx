          ...
          <div className="bg-white p-8 rounded-3xl shadow-xl max-w-md w-full text-center border border-green-100">
            ...
            <div className="bg-gray-50 rounded-2xl p-4 mb-8 text-left">
              <div className="flex justify-between text-sm mb-2">
                ...
                <span className="font-bold text-gray-900">₹{(Number(successOrder.total_amount) / 100).toLocaleString('en-IN', { minimumFractionDigits: 2 })}</span>
              </div>
                  ...
                  {products.map(product => (
                    ...
                    >
                      ...
                      <div className="text-right">
                        <p className="font-bold text-amber-600">₹{(Number(product.price) / 100).toLocaleString('en-IN', { minimumFractionDigits: 2 })}</p>
                  ...
                  cart.map(item => (
                    <div key={item.id} className="p-6 flex items-center gap-6">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-amber-600 font-semibold mt-1">₹{(Number(item.price) / 100).toLocaleString('en-IN', { minimumFractionDigits: 2 })}</p>
                      </div>
                      ...
                      <div className="w-24 text-right">
                        <p className="font-bold text-gray-900">₹{(Number(item.price * item.quantity) / 100).toLocaleString('en-IN', { minimumFractionDigits: 2 })}</p>
                      </div>
                      <button 
          ...
          <div className="flex-1 overflow-y-auto pr-2 mb-6">
            <div className="bg-gray-50 rounded-2xl p-6 space-y-4">
              <div className="flex justify-between text-gray-600">
                <span>Subtotal</span>
                <span className="font-semibold">₹{(subtotal / 100).toLocaleString('en-IN', { minimumFractionDigits: 2 })}</span>
              </div>
              ...
              <div className="pt-4 border-t border-gray-200 flex justify-between items-center">
                ...
                <span className="text-2xl font-black text-amber-600">₹{(total / 100).toLocaleString('en-IN', { minimumFractionDigits: 2 })}</span>
              </div>
            </div>
          </div>
